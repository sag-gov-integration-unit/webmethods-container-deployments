...
## from GA helm charts
helm upgrade -i --namespace $NAMESPACE -f sampleapis-mgw-bookstore.yaml sampleapis-mgw-bookstore saggov-helm-charts/samplejavaapis-sidecar-microgateway
helm upgrade -i --namespace $NAMESPACE -f sampleapis-mgw-uszip.yaml sampleapis-mgw-uszip saggov-helm-charts/samplejavaapis-sidecar-microgateway
